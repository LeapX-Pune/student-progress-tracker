...
async function $w(a) {
    return (
        ...
        new URL(a.url).pathname.split('/').pop() === 'stu_001'
            ...
            : new Response(JSON.stringify({ message: 'Student not found' }), {
                  status: 404,
                  headers: { 'Content-Type': 'application/json' },
              })
    );
...
async function Jw(a) {
    return (
        ...
        new URL(a.url).pathname.split('/')[3] === 'stu_001'
            ...
            : new Response(JSON.stringify({ message: 'Courses not found' }), {
                  status: 404,
                  headers: { 'Content-Type': 'application/json' },
              })
    );
...
async function jw(a) {
    return (
        ...
        new URL(a.url).pathname.split('/')[3] === 'stu_001'
            ...
            : new Response(JSON.stringify({ message: 'Grades not found' }), {
                  status: 404,
                  headers: { 'Content-Type': 'application/json' },
              })
    );
...
async function Qw(a) {
    ...
    return r
        ...
        : new Response(JSON.stringify({ message: 'Course not found' }), {
              status: 404,
              headers: { 'Content-Type': 'application/json' },
          });
}
...
function Uw({
    ...
    <h2 class="error-boundary__title">${a}</h2>
    <p class="error-boundary__message">${t}</p>
  `),
        e)
    ) {
        let o = document.createElement('div');
...
function $A({ title: a, message: t, type: e = ZA.type, duration: r = ZA.duration }) {
 ...
 fix/issues-57-56
  `,d.querySelector(".toast__close").addEventListener("click",()=>oS(d)),o.appendChild(d),r>0&&(d._timeout=setTimeout(()=>oS(d),r)),d}function oS(a){a._timeout&&clearTimeout(a._timeout),a.classList.add("toast--removing"),a.addEventListener("animationend",()=>{a.parentNode&&a.parentNode.removeChild(a)},{once:!0})}function pS(a,t){return dS({type:"error",title:a,message:t})}function S2(a,t){return dS({type:"info",title:a,message:t})}var sA=0;function lS(a,{content:t,position:e="top",delay:r=200}={}){let o=`tooltip-${++sA}`,d=document.createElement("span");d.className="tooltip-wrapper",a.parentNode.insertBefore(d,a),d.appendChild(a),a.setAttribute("aria-describedby",o);let p=document.createElement("span");p.className=`tooltip tooltip--${e}`,p.setAttribute("role","tooltip"),p.id=o,p.textContent=t,document.body.appendChild(p);let l=null,s=null;function h(){s&&(clearTimeout(s),s=null),l=setTimeout(()=>{n(),p.classList.add("tooltip--visible")},r)}function u(){l&&(clearTimeout(l),l=null),s=setTimeout(()=>{p.classList.remove("tooltip--visible")},100)}function n(){let f=a.getBoundingClientRect(),i=p.getBoundingClientRect(),m=8,c,x;switch(e){case"top":c=f.top-i.height-m,x=f.left+f.width/2-i.width/2;break;case"bottom":c=f.bottom+m,x=f.left+f.width/2-i.width/2;break;case"left":c=f.top+f.height/2-i.height/2,x=f.left-i.width-m;break;case"right":c=f.top+f.height/2-i.height/2,x=f.right+m;break}let M=8;x<M&&(x=M),x+i.width>window.innerWidth-M&&(x=window.innerWidth-i.width-M),c<M&&(c=M),c+i.height>window.innerHeight-M&&(c=window.innerHeight-i.height-M),p.style.top=`${c}px`,p.style.left=`${x}px`}return a.addEventListener("mouseenter",h),a.addEventListener("mouseleave",u),a.addEventListener("focus",h),a.addEventListener("blur",u),{destroy:()=>{a.removeEventListener("mouseenter",h),a.removeEventListener("mouseleave",u),a.removeEventListener("focus",h),a.removeEventListener("blur",u),p.remove()},update:f=>{p.textContent=f}}}var w={APP_NAME:"Student Progress Tracker",APP_VERSION:"0.1.0",API_BASE_URL:"/api",API_TIMEOUT:1e4,AUTH_TOKEN_KEY:"student_tracker_auth",AUTH_REDIRECT_KEY:"student_tracker_redirect",AUTH_REMEMBER_DAYS:30,ENABLE_MOCK_API:!0,ENABLE_PWA:!1,ENABLE_ANALYTICS:!1,CHART_ANIMATION_DURATION:750,CHART_RESPONSIVE:!0};function S(a,t){let e=typeof import.meta<"u"&&import.meta.env,r=typeof a=="string"&&e&&a in e?e[a]:a;return r===void 0||r===""?t:r==="true"?!0:r==="false"?!1:!isNaN(r)&&r!==""?Number(r):r}var k={APP_NAME:S("Student Progress Tracker",w.APP_NAME),APP_VERSION:S("0.1.0",w.APP_VERSION),API_BASE_URL:S("https://api.example.com/api",w.API_BASE_URL),API_TIMEOUT:S("10000",w.API_TIMEOUT),AUTH_TOKEN_KEY:S("student_tracker_auth",w.AUTH_TOKEN_KEY),AUTH_REDIRECT_KEY:S("student_tracker_redirect",w.AUTH_REDIRECT_KEY),AUTH_REMEMBER_DAYS:S("30",w.AUTH_REMEMBER_DAYS),ENABLE_MOCK_API:S("false",w.ENABLE_MOCK_API),ENABLE_PWA:S("true",w.ENABLE_PWA),ENABLE_ANALYTICS:S("true",w.ENABLE_ANALYTICS),CHART_ANIMATION_DURATION:S("750",w.CHART_ANIMATION_DURATION),CHART_RESPONSIVE:S("true",w.CHART_RESPONSIVE)};k.API_BASE_URL||console.warn("[Config] VITE_API_BASE_URL not set, using default");D();var da;try{da=typeof import.meta<"u"?import.meta.env:void 0}catch{da=void 0}var V=(a,t)=>{try{let e=da?da[a]:void 0;return e!==void 0?e:t}catch{return t}},hS={appName:V("VITE_APP_NAME","Student Progress Tracker"),appEnv:V("VITE_APP_ENV","development"),apiBaseUrl:V("VITE_API_BASE_URL","http://localhost:3001/api"),apiMockEnabled:(()=>{let a=V("VITE_ENABLE_MOCK_API",void 0);return a===void 0?!0:a===!0||a==="true"})(),authTokenKey:V("VITE_AUTH_TOKEN_KEY","auth_token"),sessionTimeoutMinutes:parseInt(V("VITE_SESSION_TIMEOUT_MINUTES","60"),10),enableAnalytics:(()=>{let a=V("VITE_ENABLE_ANALYTICS",void 0);return a===!0||a==="true"})(),enableNotifications:(()=>{let a=V("VITE_ENABLE_NOTIFICATIONS",void 0);return a===void 0?!0:a!==!1&&a!=="false"})(),cacheTtlSeconds:parseInt(V("VITE_CACHE_TTL_SECONDS","300"),10)};function L2(){return{...hS}}function _(){return hS.appEnv==="development"}var pa=class extends Error{constructor(t,{status:e,code:r,data:o}={}){super(t),this.name="AppError",this.status=e,this.code=r,this.data=o}};function fS(a){if(a instanceof pa)return a;let t=a.status||0,r={0:{title:"Network Error",message:"Unable to connect to the server. Please check your internet connection."},400:{title:"Bad Request",message:"The request was invalid. Please check your input."},401:{title:"Session Expired",message:"Your session has expired. Please log in again."},403:{title:"Access Denied",message:"You do not have permission to perform this action."},404:{title:"Not Found",message:"The requested resource could not be found."},429:{title:"Too Many Requests",message:"Please wait a moment before trying again."},500:{title:"Server Error",message:"An unexpected server error occurred. Please try again later."},503:{title:"Service Unavailable",message:"The service is temporarily unavailable. Please try again later."}}[t]||{title:"Error",message:a.message||"An unexpected error occurred."};return new pa(r.message,{status:t,data:a.data})}function uS(a){window.addEventListener("error",t=>{console.error("Global error caught:",t.error||t.message),a&&a(t.error||{message:t.message}),t.preventDefault()}),window.addEventListener("unhandledrejection",t=>{console.error("Unhandled promise rejection:",t.reason),a&&a(t.reason),t.preventDefault()})}var E=k.AUTH_TOKEN_KEY,G=k.AUTH_REDIRECT_KEY,Z=new Map;function cS(a,t){try{let e=a.getItem(t);return e===null||e===""?null:JSON.parse(e)}catch{return null}}function nS(a,t,e){try{return a.setItem(t,JSON.stringify(e)),!0}catch{return Z.set(t,JSON.stringify(e)),!1}}function k2(a,t){try{a.removeItem(t)}catch{}Z.delete(t)}function V2({token:a,expiresAt:t,user:e,rememberMe:r=!1}){let o=typeof t=="string"?new Date(t).getTime():Number(t),d={token:a,expiresAt:o,user:e};nS(r?localStorage:sessionStorage,E,d)}function la(){let a=cS(localStorage,E);if(a)return a;let t=cS(sessionStorage,E);if(t)return t;let e=Z.get(E);if(!e)return null;try{return JSON.parse(e)}catch{return null}}function O(){k2(localStorage,E),k2(sessionStorage,E),k2(sessionStorage,G)}function iS(){let a=null;try{a=sessionStorage.getItem(G),sessionStorage.removeItem(G)}catch{}return a||(a=Z.get(G)??null,Z.delete(G)),a??"/overview"}var gA=null;async function vS(){try{if(L2().apiMockEnabled){let{setupMockServer:t}=await Promise.resolve().then(()=>(MS(),mS));gA=t()}}catch(a){console.warn("[API] Failed to initialize mock server:",a)}}var P2=class{constructor(t=""){this.baseUrl=t||window.CONFIG&&window.CONFIG.API_BASE_URL||L2().apiBaseUrl||"/api",this.pendingRequests=new Map,this.timeoutMs=1e4,this.maxRetries=3}_requestInterceptor(t,e){let r=new Headers(t.headers||{});if(r.set("Content-Type","application/json"),!t.noToken&&!e.startsWith("/auth/")){let o=la();o?.token&&r.set("Authorization",`Bearer ${o.token}`)}return{...t,headers:r}}async _responseInterceptor(t){if(!t.ok){let o=new Error(`HTTP ${t.status}`);o.status=t.status;let d=t.clone();try{let l=await d.json();o.message=l.message||o.message,o.data=l}catch{let s=await t.text();o.message=s||o.message}let p=fS(o);throw t.status===401&&window.dispatchEvent(new window.CustomEvent("auth:unauthorized")),p}let e=t.headers.get("content-type");return e&&e.includes("application/json")?await t.json():await t.text()}_getRequestKey(t,e,r){return`${t}:${e}:${r||""}`}_isNetworkError(t){return t.name==="TypeError"||t.message==="Failed to fetch"||t.message.includes("NetworkError")}async request(t,e={}){let{method:r="GET",body:o,retryCount:d=0,skipDedup:p=!1,...l}=e,s=`${this.baseUrl}${t}`,h=!p&&this._getRequestKey(r,s,o);if(h&&this.pendingRequests.has(h))return _()&&console.log(`[API Dedup] Returning existing request for ${r} ${s}`),this.pendingRequests.get(h);_()&&console.log(`[API Request] ${r} ${s}`,{body:o?JSON.parse(o):null,...l});let u=Date.now(),n=this._requestInterceptor({method:r,body:o,...l},t),f=new AbortController;l.signal&&l.signal.addEventListener("abort",()=>f.abort()),n.signal=f.signal;let i,m=new Promise((M,g)=>{i=setTimeout(()=>{f.abort(),g(new Error("Request timeout"))},this.timeoutMs)}),c=fetch(s,n).then(async M=>(h&&this.pendingRequests.delete(h),_()&&console.log(`[API Response] ${r} ${s} (${M.status}) took ${Date.now()-u}ms`),await this._responseInterceptor(M))).catch(M=>{if(h&&this.pendingRequests.delete(h),_()&&console.error(`[API Error] ${r} ${s} failed after ${Date.now()-u}ms`,M),M.name==="AbortError")throw new Error(M.message==="The user aborted a request."?"Request cancelled":"Request timeout");if(d<this.maxRetries&&this._isNetworkError(M)){let g=Math.pow(2,d)*1e3;return new Promise(X=>setTimeout(()=>X(this.request(t,{...e,retryCount:d+1})),g))}throw typeof process<"u"&&process.env&&console.error(`API Error on ${t}:`,M),M}).finally(()=>{clearTimeout(i)}),x=Promise.race([c,m]);return h&&(this.pendingRequests.set(h,x),x.finally(()=>this.pendingRequests.delete(h)).catch(()=>{})),x}get(t,e={}){return this.request(t,{method:"GET",...e})}post(t,e,r={}){return this.request(t,{method:"POST",body:JSON.stringify(e),...r})}put(t,e,r={}){return this.request(t,{method:"PUT",body:JSON.stringify(e),...r})}patch(t,e,r={}){return this.request(t,{method:"PATCH",body:JSON.stringify(e),...r})}delete(t,e={}){return this.request(t,{method:"DELETE",...e})}async batch(t){if(!Array.isArray(t))throw new Error("batch() expects an array of requests");return Promise.all(t.map(e=>typeof e=="string"?this.get(e):this.request(e.endpoint,e.options||{})))}},T2=new P2;async function gS(a){try{let{API_ENDPOINTS:t}=await Promise.resolve().then(()=>(D(),sS));return await T2.get(t.STUDENT_COURSES(a))}catch(t){throw{code:t.code||"UNKNOWN",message:t.message||"Failed to fetch courses"}}}async function yS({email:a,password:t,role:e}){let r=new AbortController,o=setTimeout(()=>r.abort(),k.API_TIMEOUT||1e4);try{let d=await T2.post(H2.AUTH_LOGIN,{email:a,password:t,role:e},{signal:r.signal});return clearTimeout(o),d}catch(d){throw clearTimeout(o),d.name==="AbortError"||d instanceof TypeError?{code:T.NETWORK_ERROR,message:"Unable to connect. Please check your internet connection."}:d.status===400?{code:T.VALIDATION_ERROR,message:d.data?.message??"The request contained invalid data."}:d.status===401?{code:T.INVALID_CREDENTIALS,message:d.data?.message??"Invalid email or password."}:{code:T.UNKNOWN,message:d.data?.message??d.message??"An unexpected error occurred."}}}function CS(a){if(!a||typeof a!="string")return"?";let t=a.trim().split(/\s+/).filter(Boolean);if(t.length===0)return"?";let e=t[0][0].toUpperCase();if(t.length===1)return e;let r=t[t.length-1][0].toUpperCase();return e+r}function wS(a){let t=["#4F46E5","#0EA5E9","#10B981","#F59E0B","#EF4444","#8B5CF6","#EC4899","#14B8A6","#F97316","#6366F1"];if(!a||typeof a!="string")return t[0];let e=5381;for(let r=0;r<a.length;r++)e=e*33^a.charCodeAt(r),e=e>>>0;return t[e%t.length]}function SS(a){return!a||typeof a!="number"||isNaN(a)?!0:Date.now()>a}D();function CA(a,t){if(a&&typeof a=="object"&&"code"in a)return a;let e=a instanceof Error?a.message:typeof a=="string"?a:t;return{code:T.UNKNOWN,message:e}}var wA=Object.freeze({user:null,token:null,isAuthenticated:!1,isLoading:!0,error:null}),SA=(()=>{let a={...wA},t=new Set;function e(u){return typeof u!="function"?(console.warn("[AuthContext] subscribe() expects a function, received:",typeof u),()=>{}):(t.add(u),()=>r(u))}function r(u){t.delete(u)}function o(){let u=Object.freeze({...a});t.forEach(n=>{try{n(u)}catch(f){console.error("[AuthContext] A subscriber threw an error:",f)}})}function d(u){a={...a,...u},o()}function p(){return Object.freeze({...a})}async function l(){d({isLoading:!0,error:null});try{let u=la();if(!u){if(k.ENABLE_MOCK_API){let m={id:"mock-001",name:"Sai Shendge",email:"sai@example.com",role:"administrator"},c="mock-jwt-token-dev";V2({token:c,expiresAt:Date.now()+864e5,user:m,rememberMe:!0}),d({user:m,token:c,isAuthenticated:!0,isLoading:!1,error:null});return}d({isLoading:!1});return}let{token:n,expiresAt:f,user:i}=u;if(!n||!i||typeof i!="object"){console.warn("[AuthContext] Malformed session payload found in storage \u2014 clearing."),O(),d({isLoading:!1});return}if(SS(f)){console.warn("[AuthContext] Stored token has expired \u2014 clearing session."),O(),d({isLoading:!1});return}d({user:i,token:n,isAuthenticated:!0,isLoading:!1,error:null}),k.ENABLE_ANALYTICS||console.warn("[AuthContext] Session restored for user ID:",i.id)}catch(u){console.error("[AuthContext] restoreSession() encountered an unexpected error:",u),O(),d({isLoading:!1,error:null})}}async function s(u){d({isLoading:!0,error:null});try{let n=await yS(u),{token:f,expiresAt:i,user:m}=n;if(!f||!m||!i)throw new Error("Auth response is missing required fields: token, expiresAt, user.");let c=u.rememberMe===!0;return V2({token:f,expiresAt:i,user:m,rememberMe:c}),d({user:m,token:f,isAuthenticated:!0,isLoading:!1,error:null}),{success:!0,user:m}}catch(n){let f=CA(n,"Login failed. Please try again.");return d({isLoading:!1,error:f,isAuthenticated:!1,user:null,token:null}),{success:!1,error:f.message}}}function h(){O(),d({user:null,token:null,isAuthenticated:!1,isLoading:!1,error:null}),console.warn(`[AuthContext] Session ended. Navigate to ${A2.LOGIN} via the router.`)}return window.addEventListener("auth:unauthorized",()=>{a.isAuthenticated&&(console.warn("[AuthContext] 401 Unauthorized detected globally. Logging out."),h())}),{subscribe:e,unsubscribe:r,notify:o,getState:p,setState:d,restoreSession:l,login:s,logout:h,clearStorage:O}})(),C=SA;var AS={sm:32,md:40,lg:56};function LS(a,t="md",e=""){let r=AS[t]??AS.md,o=CS(a?.name??""),d=wS(a?.id??a?.name??""),p=document.createElement("div");if(p.className=`user-avatar user-avatar--${t}${e?` ${e}`:""}`,p.style.width=`${r}px`,p.style.height=`${r}px`,p.setAttribute("aria-hidden","true"),a?.avatarUrl){let l=document.createElement("img");l.src=a.avatarUrl,l.alt=`${a.name??"User"} avatar`,l.className="user-avatar__img",l.width=r,l.height=r,l.addEventListener("error",()=>{p.removeChild(l),HS(p,o,d)}),p.appendChild(l)}else HS(p,o,d);return p}function HS(a,t,e){let r=document.createElement("span");r.className="user-avatar__initials",r.textContent=t,r.style.backgroundColor=e,a.appendChild(r)}function kS(a){let t=a==="administrator",e=a==="teacher",r,o;return t?(r="Administrator",o="role-badge--administrator"):e?(r="Teacher",o="role-badge--teacher"):(r="Student",o="role-badge--student"),`<span class="role-badge ${o}">${r}</span>`}function AA(a){if(!a||typeof a!="object")return;let t=document.querySelector("[data-profile-toggle]");if(t){let r=t.querySelector(".avatar, .user-avatar"),o;a.role==="teacher"?o="avatar-ring--teacher":a.role==="administrator"?o="avatar-ring--administrator":o="avatar-ring--student";let d=LS(a,"sm",o);r?r.replaceWith(d):t.prepend(d);let p=t.querySelector(".profile-name");p&&(p.textContent=a.name);let l=t.querySelector(".profile-role");l&&(l.innerHTML=kS(a.role??"student"))}let e=document.querySelector("[data-profile-dropdown]");if(e){let r=e.querySelector(".profile-summary-header");r||(r=document.createElement("div"),r.className="profile-summary-header",e.prepend(r));let o=a.role==="teacher",d=o?`${a.department??"Faculty"} \u2022 ${a.designation??"Teacher"}`:`${a.class??"Student"} \u2022 Roll No: ${a.rollNumber??"N/A"}`,p=o?`ID: ${a.teacherId??a.id}`:`ID: ${a.studentId??a.id}`;r.innerHTML=`
            <div class="flex items-center justify-between gap-2 mb-1">
              <span class="profile-summary-name truncate">${a.name}</span>
              ${kS(a.role??"student")}
            </div>
            <div class="profile-summary-email truncate">${a.email}</div>
            <div class="flex items-center justify-between text-xs pt-1 border-t border-[var(--border-subtle)]">
              <span class="status-indicator">
                <span class="status-dot"></span> ${(a.status??"active").charAt(0).toUpperCase()+(a.status??"active").slice(1)}
              </span>
              <span class="text-[11px] font-mono text-[var(--text-tertiary)]">${p}</span>
            </div>
            <div class="profile-summary-details font-medium">${d}</div>
        `}typeof window<"u"&&window.lucide&&typeof window.lucide.createIcons=="function"&&window.lucide.createIcons()}function R2(a,t=document){if(!a||typeof a!="object")return;let e=t.querySelector("[data-welcome-title], #welcome-title, .welcome-title");e&&(e.textContent=`Welcome back, ${a.name}`);let r=t.querySelector("[data-welcome-subtitle], #welcome-subtitle, .welcome-subtitle");if(r){let o=a.role==="teacher";r.textContent=o?`${a.department??"Faculty"} \u2022 ${a.designation??"Senior Educator"}`:`${a.class??"Class 10-A"} \u2022 Roll No: ${a.rollNumber??"24"}`}}function VS(){function a(e){e.isAuthenticated&&e.user&&(AA(e.user),R2(e.user))}let t=C.subscribe(a);return a(C.getState()),t}function bS(a,t){return!t||t===0?0:Math.round(a/t*100)}function PS(a){let t={completed:{className:"course-status-badge--completed",label:"Completed"},"in-progress":{className:"course-status-badge--in-progress",label:"In Progress"},"not-started":{className:"course-status-badge--not-started",label:"Not Started"}};return t[a]||t["not-started"]}function TS(a){if(a==null)return"N/A";if(typeof a=="string")return a;let t="F";return a>=97?t="A+":a>=93?t="A":a>=90?t="A-":a>=87?t="B+":a>=83?t="B":a>=80?t="B-":a>=77?t="C+":a>=73?t="C":a>=70?t="C-":a>=60&&(t="D"),`${t} (${Math.round(a)}%)`}function RS(a,t){let e=document.createElement("div");e.className="course-thumbnail";let r=document.createElement("div");if(r.className="course-thumbnail__container",a){let o=document.createElement("img");o.className="course-thumbnail__img",o.src=a,o.alt=`${t} thumbnail`,o.loading="lazy",o.onerror=()=>{o.style.display="none"},r.appendChild(o)}return e.appendChild(r),e}function BS(a,t,e){let r=bS(a,t),o=document.createElement("div");o.className="course-progress-section";let d=document.createElement("div");d.className="course-progress-header";let p=document.createElement("span");p.className="course-progress-label",p.textContent="Progress";let l=document.createElement("span");l.className="course-progress-percentage",l.textContent=`${r}%`,d.appendChild(p),d.appendChild(l);let s=document.createElement("div");s.className="course-progress-bar";let h=document.createElement("div");h.className="course-progress-bar__track";let u=document.createElement("div");return u.className="course-progress-bar__fill",e==="completed"||r===100?u.classList.add("course-progress-bar__fill--completed"):(e==="not-started"||r===0)&&u.classList.add("course-progress-bar__fill--not-started"),u.style.width="0%",requestAnimationFrame(()=>{setTimeout(()=>{u.style.width=`${r}%`},50)}),h.appendChild(u),s.appendChild(h),o.appendChild(d),o.appendChild(s),o}function DS(a){let t=PS(a),e=document.createElement("span");return e.className=`course-status-badge ${t.className}`,e.textContent=t.label,e}function ES(a){let t=document.createElement("div");t.className="course-card",t.setAttribute("tabindex","0"),t.appendChild(RS(a.thumbnailUrl,a.title));let e=document.createElement("div");e.className="course-card__content";let r=document.createElement("div");r.className="course-card__header";let o=document.createElement("h3");o.className="course-card__title",o.textContent=a.title;let d=document.createElement("p");d.className="course-card__instructor",d.textContent=a.instructor,r.appendChild(o),r.appendChild(d),e.appendChild(r);let p=document.createElement("div");p.className="course-card__status-wrapper",p.appendChild(DS(a.status)),e.appendChild(p);let l=document.createElement("div");l.className="course-card__details";let s=document.createElement("div");s.className="course-card__detail-row";let h=document.createElement("span");h.className="course-card__detail-label",h.textContent="Modules";let u=document.createElement("span");u.className="course-card__detail-value",u.textContent=`${a.completedModules} / ${a.totalModules}`,s.appendChild(h),s.appendChild(u),l.appendChild(s);let n=document.createElement("div");n.className="course-card__detail-row";let f=document.createElement("span");f.className="course-card__detail-label",f.textContent="Grade";let i=document.createElement("span");i.className="course-card__detail-value",a.currentGrade!==null&&a.currentGrade!==void 0?i.textContent=TS(a.currentGrade):i.textContent="N/A",n.appendChild(f),n.appendChild(i),l.appendChild(n);let m=document.createElement("div");m.className="course-card__detail-row";let c=document.createElement("span");c.className="course-card__detail-label",c.textContent="Next";let x=document.createElement("span");return x.className="course-card__detail-value",a.status==="completed"?(x.textContent="-",x.classList.add("course-card__detail-value--muted")):a.nextModule?x.textContent=a.nextModule:x.textContent="N/A",m.appendChild(c),m.appendChild(x),l.appendChild(m),e.appendChild(l),e.appendChild(BS(a.completedModules,a.totalModules,a.status)),t.appendChild(e),t}function FS(a,t){if(!a)return;a.innerHTML="";let e=document.createElement("div");if(e.className="course-progress-grid",!t||t.length===0){let r=document.createElement("div");r.className="course-progress-grid__empty",r.textContent="No courses found.",a.appendChild(r);return}t.forEach(r=>{let o=ES(r);e.appendChild(o)}),a.appendChild(e)}function OS({title:a="Something went wrong",message:t,onRetry:e}){let r=document.createElement("div");r.className="course-progress-grid__error",r.style.display="flex",r.style.flexDirection="column",r.style.alignItems="center",r.style.justifyContent="center",r.style.padding="4rem 2rem",r.style.textAlign="center",r.style.gap="1rem",r.style.gridColumn="1 / -1";let o=document.createElement("div");o.style.color="var(--error-default, #ef4444)",o.style.marginBottom="1rem",o.innerHTML='<i data-lucide="alert-triangle" style="width: 48px; height: 48px;"></i>';let d=document.createElement("h3");d.textContent=a,d.style.fontSize="1.25rem",d.style.fontWeight="600",d.style.margin="0",d.style.color="var(--text-primary, #f8fafc)";let p=document.createElement("p");p.textContent=t||"There was an error loading the data. Please try again.",p.style.color="var(--text-secondary, #94a3b8)",p.style.margin="0 0 1rem 0",p.style.maxWidth="400px";let l=document.createElement("button");return l.textContent="Retry",l.className="btn btn-primary",l.style.padding="0.5rem 1.5rem",l.style.borderRadius="var(--radius-md, 8px)",l.style.backgroundColor="var(--primary-main, #3b82f6)",l.style.color="#fff",l.style.border="none",l.style.cursor="pointer",l.style.fontWeight="500",e&&l.addEventListener("click",e),r.append(o,d,p,l),typeof lucide<"u"&&lucide.createIcons?lucide.createIcons({icons:lucide.icons,root:r}):L({root:r}),r}function US(){let a=document.createElement("article");a.className="skeleton-card";let t=document.createElement("div");t.className="skeleton-card__thumbnail skeleton-bone",a.appendChild(t);let e=document.createElement("div");e.className="skeleton-card__content";let r=document.createElement("div");r.className="skeleton-card__title skeleton-bone";let o=document.createElement("div");o.className="skeleton-card__subtitle skeleton-bone";let d=document.createElement("div");d.className="skeleton-card__badge skeleton-bone";let p=document.createElement("div");p.className="skeleton-card__row";let l=document.createElement("div");l.className="skeleton-card__label skeleton-bone";let s=document.createElement("div");s.className="skeleton-card__value skeleton-bone",p.append(l,s);let h=document.createElement("div");h.className="skeleton-card__row";let u=document.createElement("div");u.className="skeleton-card__label skeleton-bone";let n=document.createElement("div");n.className="skeleton-card__value skeleton-bone",h.append(u,n);let f=document.createElement("div");f.className="skeleton-card__row";let i=document.createElement("div");i.className="skeleton-card__label skeleton-bone";let m=document.createElement("div");m.className="skeleton-card__title skeleton-bone",m.style.width="60%",f.append(i,m);let c=document.createElement("div");c.className="skeleton-card__row",c.style.marginTop="0.5rem";let x=document.createElement("div");x.className="skeleton-card__label skeleton-bone";let M=document.createElement("div");M.className="skeleton-card__value skeleton-bone",c.append(x,M);let g=document.createElement("div");return g.className="skeleton-card__bar skeleton-bone",e.append(r,o,d,p,h,f,c,g),a.appendChild(e),a}function zS({onLoading:a,onSuccess:t,onError:e}){let r=null,o=async p=>{r=p,a&&a();try{let l=await gS(p);t&&t(l)}catch(l){e&&e(l)}};return{fetch:o,retry:()=>{r&&o(r)}}}function qS(){let a=document.querySelector("[data-page-content]");if(!a)return;let t=null,e=null,r=()=>{let s=a.querySelector(".route-placeholder");s?s.remove():a.innerHTML="",e=document.createElement("h1"),e.className="dashboard-title",e.textContent="Courses",e.style.marginBottom="2rem",e.style.fontSize="2.25rem",e.style.fontWeight="700",t=document.createElement("div"),a.append(e,t)},o=zS({onLoading:()=>{(!t||!document.body.contains(t))&&r(),t.innerHTML="";let s=document.createElement("div");s.className="course-progress-grid";for(let h=0;h<3;h++)s.appendChild(US());t.appendChild(s)},onSuccess:s=>{if(t){if(t.innerHTML="",!s||s.length===0){t.appendChild(oa({title:"No Courses Yet",description:"You haven't been enrolled in any courses for this term.",illustration:Yw.course}));return}FS(t,s)}},onError:s=>{t&&(t.innerHTML="",t.appendChild(OS({title:"Failed to load courses",message:s.message||"There was a problem fetching your courses.",onRetry:()=>o.retry()})))}}),d=!1,p=async()=>{if(!d){d=!0;try{await o.fetch("stu_001")}finally{d=!1}}};document.addEventListener("pathway:route",s=>{s.detail.route==="courses"&&p()}),window.location.hash.replace(/^#\/?/,"").split("?")[0].trim()==="courses"&&p()}var IS="/hero-illustration-TKMAOSZ2.jpg";D();var LA=/^[^\s@]+@[^\s@]+\.[^\s@]+$/;function kA(a){let t=(a??"").trim();return t?LA.test(t)?null:"Enter a valid email address":"Email is required"}function VA(a){let t=a??"";return t?t.length<v.MIN_PASSWORD_LENGTH?`Password must be at least ${v.MIN_PASSWORD_LENGTH} characters`:null:"Password is required"}function NS({email:a,password:t}){let e={email:kA(a),password:VA(t)};return bA(e)?null:e}function bA(a){return!a||typeof a!="object"?!1:Object.values(a).every(t=>t===null)}D();function _S({initialRole:a="student",onFill:t}={}){let e=a,r=document.createElement("div");r.className="p-4.5 sm:p-5 bg-[#F1F5F9] border border-[#CBD5E1] rounded-xl text-left shadow-xs",r.setAttribute("role","note"),r.setAttribute("aria-label","Demo login credentials");let o=window.innerWidth>=640,d=document.createElement("button");d.type="button",d.className="w-full text-xs text-[#334155] font-bold uppercase tracking-wider flex items-center gap-1.5 focus:outline-none",d.innerHTML='<span class="material-symbols-outlined text-[16px] text-primary">info</span> <span id="demo-title">Demo credentials</span> <span class="material-symbols-outlined text-[16px] ml-auto transition-transform duration-200" id="demo-chevron">expand_more</span>',r.appendChild(d);let p=document.createElement("div");p.id="demo-content";let l=document.createElement("p");l.className="text-[12px] leading-[1.5] text-[#475569] mb-1.5 flex items-center";let s=document.createElement("p");s.className="text-[12px] leading-[1.5] text-[#475569] mb-3 flex items-center";function h(f){return f==="teacher"&&v.DEMO_TEACHER?v.DEMO_TEACHER:v.DEMO_STUDENT||{email:v.DEMO_EMAIL,password:v.DEMO_PASSWORD}}function u(f){e=f;let i=h(f),m=f.charAt(0).toUpperCase()+f.slice(1),c=d.querySelector("#demo-title");c&&(c.textContent=`Demo ${m} credentials`),l.innerHTML=`<span class="w-20 font-medium">Email:</span>
      <code class="font-mono text-[#0F172A] bg-white border border-[#CBD5E1] px-2 py-0.5 rounded text-[12px] shadow-xs">${i.email}</code>`,s.innerHTML=`<span class="w-20 font-medium">Password:</span>
      <code class="font-mono text-[#0F172A] bg-white border border-[#CBD5E1] px-2 py-0.5 rounded text-[12px] shadow-xs">${i.password}</code>`}if(u(a),p.appendChild(l),p.appendChild(s),typeof t=="function"){let f=document.createElement("button");f.type="button",f.className="text-[12px] font-semibold text-primary hover:underline inline-flex items-center gap-1 focus:outline-none",f.innerHTML='<span>Use demo credentials</span> <span class="material-symbols-outlined text-[14px]">arrow_forward</span>',f.addEventListener("click",()=>{let i=h(e);t({email:i.email,password:i.password,role:e})}),p.appendChild(f)}r.appendChild(p);function n(){p.style.display=o?"":"none";let f=r.querySelector("#demo-chevron");f&&(f.style.transform=o?"rotate(180deg)":"")}return n(),d.addEventListener("click",()=>{o=!o,n()}),r.setRole=u,r}function GS({id:a,name:t,label:e,checked:r=!1,disabled:o=!1,className:d="",onChange:p}={}){let l=document.createElement("div");l.className=`flex items-center gap-2 my-3${d?` ${d}`:""}`;let s=document.createElement("input");s.type="checkbox",s.id=a,s.name=t,s.checked=r,s.disabled=o,s.setAttribute("width","16"),s.setAttribute("height","16"),s.style.cssText="width: 16px !important; height: 16px !important; min-width: 16px !important; min-height: 16px !important; max-width: 16px !important; max-height: 16px !important; cursor: pointer; margin: 0; shrink: 0;",s.className="w-4 h-4 text-primary bg-surface border-outline-variant rounded focus:ring-primary focus:ring-2 cursor-pointer shrink-0",typeof p=="function"&&s.addEventListener("change",p);let h=document.createElement("label");return h.htmlFor=a,h.className="font-label-sm text-xs font-medium text-on-surface select-none cursor-pointer leading-none",h.textContent=e??"",l.appendChild(s),l.appendChild(h),{wrapper:l,input:s}}function ZS({checked:a=!1,onChange:t}={}){let{wrapper:e,input:r}=GS({id:"remember-me",name:"rememberMe",label:"Remember me",checked:a,className:"remember-me",onChange:typeof t=="function"?o=>t(o.target.checked):void 0});return{wrapper:e,getValue:()=>r.checked}}function WS({initialRole:a="student",onChange:t}={}){let e=a,r="flex-1 py-2 px-4 rounded-lg text-sm font-semibold text-center transition-all duration-200 cursor-pointer select-none",o="bg-white shadow-md border border-[#CBD5E1] text-primary font-bold",d="text-[#64748B] hover:text-[#0F172A] font-medium opacity-80 hover:opacity-100",p=document.createElement("div");p.className="flex p-1 bg-[#E2E8F0] rounded-xl mb-4 border border-[#CBD5E1] shadow-inner",p.id="role-selector",p.setAttribute("role","tablist");let l=document.createElement("button");l.type="button",l.setAttribute("role","tab"),l.setAttribute("data-role","student"),l.setAttribute("aria-selected",a==="student"?"true":"false"),l.className=`${r} ${a==="student"?o:d}`,l.textContent="Student";let s=document.createElement("button");s.type="button",s.setAttribute("role","tab"),s.setAttribute("data-role","teacher"),s.setAttribute("aria-selected",a==="teacher"?"true":"false"),s.className=`${r} ${a==="teacher"?o:d}`,s.textContent="Teacher",p.appendChild(l),p.appendChild(s);function h(n){n!=="student"&&n!=="teacher"||(e=n,l.setAttribute("aria-selected",n==="student"?"true":"false"),l.className=`${r} ${n==="student"?o:d}`,s.setAttribute("aria-selected",n==="teacher"?"true":"false"),s.className=`${r} ${n==="teacher"?o:d}`,typeof t=="function"&&t(e))}function u(n){let f=n.target.closest("button[data-role]");if(!f)return;let i=f.getAttribute("data-role");h(i)}return p.addEventListener("click",u),{element:p,getSelectedRole(){return e},setRole:h,destroy(){p.removeEventListener("click",u),p.remove()}}}function XS(a,{onSuccess:t}={}){let e=!0,r=document.createElement("div");r.className="login-form-card slide-in-right delay-200",r.innerHTML=`
    ...
    `;let o=r.querySelector("#auth-title"),d=r.querySelector("#auth-subtitle"),p=r.querySelector("#error-banner"),l=r.querySelector("#login-form"),s=r.querySelector("#name-field"),h=r.querySelector("#email"),u=r.querySelector("#email-error"),n=r.querySelector("#password"),f=r.querySelector("#toggle-password-btn"),i=r.querySelector("#password-error"),m=r.querySelector("#forgot-password-link"),c=r.querySelector("#confirm-password-field"),x=r.querySelector("#confirm-password"),M=r.querySelector("#confirm-password-error"),g=r.querySelector("#submit-btn");h.addEventListener("input",()=>{u.textContent="",q()}),n.addEventListener("input",()=>{i.textContent="",q()}),f.addEventListener("click",()=>{let y=n.type==="password";n.type=y?"text":"password";let R=f.querySelector(".material-symbols-outlined");R&&(R.textContent=y?"visibility":"visibility_off")}),m.addEventListener("click",y=>{y.preventDefault(),window.alert("Password reset feature: Please contact your school administrator or check your email.")}),x.addEventListener("input",()=>{M.textContent=""});let X=r.querySelector("#toggle-text"),sa=r.querySelector("#toggle-mode-btn"),ha=_S({initialRole:"student",onFill:({email:y,password:R,role:F})=>{h.value=y,n.value=R,F&&typeof z.setRole=="function"&&z.setRole(F),u.textContent="",i.textContent="",q()}});r.querySelector("#demo-mount").appendChild(ha);let z=WS({initialRole:"student",onChange:y=>{typeof ha.setRole=="function"&&ha.setRole(y)}});r.querySelector("#role-selector-mount").appendChild(z.element);let D2=ZS({checked:!1});r.querySelector("#remember-me-mount").appendChild(D2.wrapper),a.appendChild(r);function aA(y){p.textContent=y,p.style.display="block"}function q(){p.textContent="",p.style.display="none"}function E2(y){g.disabled=y,y?g.innerHTML='<span class="material-symbols-outlined animate-spin text-[18px]">progress_activity</span> Processing...':e?g.innerHTML='Sign In <span class="material-symbols-outlined text-[18px]">arrow_forward</span>':g.innerHTML='Create Account <span class="material-symbols-outlined text-[18px]">person_add</span>'}sa.addEventListener("click",()=>{e=!e,q(),l.style.opacity="0",l.style.transition="opacity 0.15s ease-out",setTimeout(()=>{e?(o.textContent="Welcome back",d.textContent="Log in to your The Reality account.",g.innerHTML='Sign In <span class="material-symbols-outlined text-[18px]">arrow_forward</span>',s.style.display="none",c.style.display="none",m.style.display="inline",X.textContent="Don't have an account?",sa.textContent="Sign up"):(o.textContent="Join The Reality",d.textContent="Create an account to start tracking progress.",g.innerHTML='Create Account <span class="material-symbols-outlined text-[18px]">person_add</span>',s.style.display="block",c.style.display="block",m.style.display="none",X.textContent="Already have an account?",sa.textContent="Log in"),l.style.opacity="1"},150)});async function F2(y){y.preventDefault(),q();let R=h.value.trim(),F=n.value,tA=z.getSelectedRole(),eA=D2.getValue(),B=NS({email:R,password:F});if(B){B.email&&(u.textContent=B.email),B.password&&(i.textContent=B.password),B.email?h.focus():B.password&&n.focus();return}if(!e&&x.value!==F){M.textContent="Passwords do not match.",x.focus();return}E2(!0);let fa=await C.login({email:R,password:F,role:tA,rememberMe:eA});if(E2(!1),fa.success){let O2=iS();typeof t=="function"&&t(fa.user,O2)}else aA(fa.error??"Login failed. Please verify your credentials."),h.focus()}return l.addEventListener("submit",F2),{destroy(){l.removeEventListener("submit",F2),z.destroy(),a.contains(r)&&a.removeChild(r)}}}var PA="The Reality - Student Progress Tracker Authentication";function TA(a){let{isAuthenticated:t,isLoading:e}=C.getState();if(!e&&t)return window.location.hash="/overview",{destroy:()=>{}};document.title=PA;let r=document.createElement("div");r.id="login-page",r.innerHTML=`
  ...
  <footer class="login-footer">
    <div class="login-footer-brand">
      ...
      <span class="login-footer-copy">\xA9 2024 The Reality Academy. All rights reserved.</span>
    </div>
    ...
    `,a.appendChild(r);let o=r.querySelector("#form-mount-container"),d=XS(o,{onSuccess:(l,s)=>{window.location.hash=s}}),p=C.subscribe(({isAuthenticated:l})=>{l&&(window.location.hash="/overview")});return{destroy(){p(),d.destroy(),a.contains(r)&&a.removeChild(r),document.title="Student Progress Tracker"}}}var KS=TA;var B2=!1;function $S(){let a=window.matchMedia("(prefers-reduced-motion: reduce)");B2=a.matches,a.addEventListener("change",t=>{B2=t.matches,document.documentElement.classList.toggle("reduced-motion",t.matches)}),document.documentElement.classList.toggle("reduced-motion",B2)}var RA=new Map;function BA(a){RA.set(a,window.scrollY)}function jS(){"scrollRestoration"in window.history&&(window.history.scrollRestoration="manual"),window.addEventListener("beforeunload",()=>{BA(window.location.pathname)})}function DA(){let a=localStorage.getItem("theme");return a==="dark"||a==="light"?a:window.matchMedia&&window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function EA(a){a==="dark"?(document.body.classList.add("dark"),localStorage.setItem("theme","dark")):(document.body.classList.remove("dark"),localStorage.setItem("theme","light"))}function JS(){let a=DA();return EA(a),a}typeof window<"u"&&(window.lucide={createIcons:()=>L({icons:b})});var W=null;function FA(){uS(a=>{let t=a?.message||a?.reason?.message||"An unexpected error occurred.";pS("Error",t)})}function OA(){window.addEventListener("offline",()=>{S2("Offline","You are currently offline. Some features may be unavailable.")}),window.addEventListener("online",()=>{S2("Back Online","Your internet connection has been restored.")})}function UA(){let a=document.querySelector("[data-page-content]");a&&(document.addEventListener("pathway:route",()=>{window._pageContent=a}),window._showErrorBoundary=({title:t,message:e,onRetry:r}={})=>{Qw(a,{title:t,message:e,onRetry:r})})}function zA(){let a=document.querySelector("[data-page-content]");a&&(document.addEventListener("pathway:route",()=>{w2(a)}),window._removePageSkeletons=()=>{w2(a)})}function qA(){document.querySelectorAll(".icon-button, .action-btn-circle").forEach(a=>{let t=a.getAttribute("aria-label")||a.querySelector(".nav-label")?.textContent?.trim();t&&lS(a,{content:t,position:"bottom"})})}function IA(){let a=document.querySelector("[data-page-content]");a&&(document.addEventListener("pathway:route",()=>{L({icons:b}),a.querySelector(".route-placeholder, .settings-page")}),window._showEmptyState=t=>{let e=oa(t);a.innerHTML="",a.appendChild(e),L({icons:b})},window._showModal=t=>{let e=C2(t);return L({icons:b}),e},document.querySelector("[data-notification-clear]")?.addEventListener("click",()=>{C2({title:"Clear Notifications",body:"Mark all notifications as read?",footer:'<button class="btn btn--primary" data-confirm-clear>Clear all</button>',onClose:()=>{}})}))}function YS(a){let t=document.querySelector("[data-page-content]"),e=document.querySelector(".app-shell");W&&typeof W.destroy=="function"&&(W.destroy(),W=null);let{isAuthenticated:r,user:o}=C.getState();if(!r&&a!=="login"){window.location.hash="#/login";return}a==="login"?(e&&e.classList.add("is-auth-view"),t&&(t.innerHTML="",W=KS(t))):(e&&e.classList.remove("is-auth-view"),o&&R2(o)),typeof window<"u"&&window.lucide&&typeof window.lucide.createIcons=="function"&&window.lucide.createIcons()}async function QS(){JS(),$S(),jS(),FA(),UA(),OA();let a=aS({size:"lg",label:"Loading application..."});a.style.cssText="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);z-index:1000;",document.body.appendChild(a),zA(),await vS(),await C.restoreSession();let{isAuthenticated:t}=C.getState(),e=window.location.hash.replace(/^#\/?/,"").split("?")[0].trim();!t&&e!=="login"?window.location.hash="#/login":t&&(e==="login"||!e)&&(window.location.hash="#/overview"),document.addEventListener("pathway:route",d=>{let p=d.detail?.route;YS(p)}),YS(e||(t?"overview":"login")),qS(),VS();let r=document.querySelector(".profile-dropdown-item--danger");r&&r.addEventListener("click",()=>{C.logout(),window.location.hash="#/login"}),L({icons:b}),qA(),IA(),a.parentNode&&a.parentNode.removeChild(a);let o=document.querySelector(".app-shell");o&&o.classList.add("app--ready")}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",QS):QS();
...
function C(a, t) {
    let e = typeof import.meta < 'u' && import.meta.env,
        r = e ? e[a] : void 0;
    return r 
...
var S = {
    APP_NAME: C('VITE_APP_NAME', y.APP_NAME),
    APP_VERSION: C('VITE_APP_VERSION', y.APP_VERSION),
    API_BASE_URL: C('VITE_API_BASE_URL', y.API_BASE_URL),
    API_TIMEOUT: C('VITE_API_TIMEOUT', y.API_TIMEOUT),
    AUTH_TOKEN_KEY: C('VITE_AUTH_TOKEN_KEY', y.AUTH_TOKEN_KEY),
    AUTH_REDIRECT_KEY: C('VITE_AUTH_REDIRECT_KEY', y.AUTH_REDIRECT_KEY),
    AUTH_REMEMBER_DAYS: C('VITE_AUTH_REMEMBER_DAYS', y.AUTH_REMEMBER_DAYS),
    ENABLE_MOCK_API: C('VITE_ENABLE_MOCK_API', y.ENABLE_MOCK_API),
    ENABLE_PWA: C('VITE_ENABLE_PWA', y.ENABLE_PWA),
    ENABLE_ANALYTICS: C('VITE_ENABLE_ANALYTICS', y.ENABLE_ANALYTICS),
    CHART_ANIMATION_DURATION: C('VITE_CHART_ANIMATION_DURATION', y.CHART_ANIMATION_DURATION),
...
var C2 = class {
        ...
        get(t, e = {}) {
            return this.request(t, { method: 'GET', ...e });
        }
        post(t, e, r = {}) {
            return this.request(t, { method: 'POST', body: JSON.stringify(e), ...r });
        }
        put(t, e, r = {}) {
            return this.request(t, { method: 'PUT', body: JSON.stringify(e), ...r });
        }
        patch(t, e, r = {}) {
            return this.request(t, { method: 'PATCH', body: JSON.stringify(e), ...r });
        }
        delete(t, e = {}) {
...
function kw({ onFill: a } = {}) {
    ...
    ((t.className = 'demo-credentials'),
        ...
        t.setAttribute('aria-label', 'Demo login credentials'));
    let e = document.createElement('p');
    ((e.className = 'demo-credentials__heading'),
        (e.textContent = 'Demo credentials'),
        t.appendChild(e));
...
function Tw(a, { onSuccess: t } = {}) {
    ...
    return (
        ...
        {
            destroy() {
                (e.removeEventListener('submit', v), a.removeChild(e));
            },
        }
    );
}
