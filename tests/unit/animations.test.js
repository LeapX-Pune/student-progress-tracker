...
import { animate, stagger, initMotionPreferences, shouldAnimate, ANIMATION_CLASSES } from '../../src/utils/animations.js'
...
describe('animations', () => {
  ...
  it('stagger applies animation to children with delay', () => {
    ...
    const childSpies = Array.from(parent.children).map(child => {
