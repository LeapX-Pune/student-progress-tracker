...
export const handlers = [
  http.post('/api/auth/login', async ({ request }) => {
    ...
    if (email === 'student@demo.com' && password === 'demo123') {
      return HttpResponse.json({
        ...
        user: {
          id: 'stu_001', name: 'Alex Johnson', email: 'alex@student.edu',
  ...
  http.get('/api/students/:studentId', ({ params }) => {
    if (params.studentId === 'stu_001') {
      return HttpResponse.json({
        id: 'stu_001', name: 'Alex Johnson', email: 'alex@student.edu',
        avatarUrl: 'https://api.dicebear.com/7.x/avataaars/svg?seed=alex',
        studentId: 'STU-2024-001', enrolledAt: '2024-01-15T00:00:00Z',
        courses: [
          { id: 'course_001', title: 'Full Stack Web Development', instructor: 'Dr. Sarah Chen',
            thumbnailUrl: 'https://picsum.photos/seed/webdev/400/225',
            totalModules: 20, completedModules: 13, status: 'in-progress', currentGrade: 87.5,
            term: 'Spring 2024', lastAccessedAt: '2024-01-19T10:00:00Z' },
        ],
      })
    }
  ...
  http.get('/api/students/:studentId/courses', ({ params }) => {
    if (params.studentId === 'stu_001') {
      return HttpResponse.json([
        { id: 'course_001', studentId: 'stu_001', title: 'Full Stack Web Development',
        ...
        { id: 'course_002', studentId: 'stu_001', title: 'Data Structures & Algorithms',
          ...
          totalModules: 15, completedModules: 8, status: 'in-progress', currentGrade: 78.2,
          term: 'Spring 2024', lastAccessedAt: '2024-01-18T14:30:00Z',
          nextModule: { id: 'mod_09', title: 'Graph Algorithms' } },
        { id: 'course_003', studentId: 'stu_001', title: 'UX Design Fundamentals',
          instructor: 'Jane Smith',
          thumbnailUrl: 'https://picsum.photos/seed/ux/400/225',
          description: 'User experience design principles',
          totalModules: 12, completedModules: 12, status: 'completed', currentGrade: 94.0,
          term: 'Fall 2023', lastAccessedAt: '2023-12-15T09:00:00Z' },
      ])
    }
    return HttpResponse.json({ message: 'No courses found' }, { status: 404 })
  }),

  http.get('/api/students/:studentId/grades', ({ params }) => {
    if (params.studentId === 'stu_001') {
      return HttpResponse.json({
        quizScores: [
    ...
    return HttpResponse.json({ message: 'No grade data found' }, { status: 404 })
  }),
]
